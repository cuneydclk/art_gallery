...
LOGIN_REDIRECT_URL = '/gallery/'  # Redirect to the gallery list after login
LOGOUT_REDIRECT_URL = '/gallery/' # Redirect to the gallery list after logout (optional, but good practice)
